...
```
ghcr.io/irnutsmurt/protectarr:0.3.1    # exact release, never moves
ghcr.io/irnutsmurt/protectarr:0.3      # newest patch of that minor line
ghcr.io/irnutsmurt/protectarr:latest   # newest master build
ghcr.io/irnutsmurt/protectarr:master   # same thing, named explicitly
```

Pin to `0.3.1` or `0.3` if you want to know what you are running. Use `latest`
